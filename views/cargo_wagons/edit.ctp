...
<h2><?php __('CargoWagon');?></h2>
    <?php
        echo $this->SimplaBoxes->start_content_box(__('Uprava nákladního vozu', true));
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Smaž nákladní vůz', true), array('action' => 'delete', $this->Form->value('CargoWagon.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('CargoWagon.id'))); ?></li>
